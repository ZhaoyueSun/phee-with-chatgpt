...
"""
training script for finetuning UIE model on PHEE dataset. 
"""
    ...
    if data_args.pad_to_max_length:
        ...
        data_collator = DataCollatorForMetaSeq2Seq(
            ...
            negative_sampler=DynamicSSIGenerator(
                ...
                positive_rate=data_args.meta_positive_rate, # how many positivate spot/asco reserved for prefix
                negative=data_args.meta_negative,  # -1 for using all spot/asoc as prefix
                ordered_prompt=data_args.ordered_prompt, # false for randomize the prefix
            ),
...
if __name__ == "__main__":
    ...
    sys.argv.extend(['train_script_config/uie_base_finetune_phee.json'])
    main()
