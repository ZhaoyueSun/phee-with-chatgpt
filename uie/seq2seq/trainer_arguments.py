...
class DataTrainingArguments:
    ...
    demo_num: int = field(
        default=0, metadata={"help": "Number of in-context demonstration examples. "}
    )
    
    prompt_strategy: str = field(
        default='random', metadata={"help": "Strategy to select demonstration examples. Used together with demo_num."}
    )
