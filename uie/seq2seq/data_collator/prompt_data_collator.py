...
class PromptDataCollatorForSeq2Seq:
    ...
    def __call__(self, features):
        ...
        for feature in features:
            ...
            positive_spot, negative_spot = self.negative_sampler.sample_spot(positive=feature.get('spots', []))
            negative_asoc = self.negative_sampler.sample_asoc(positive=feature.get('asocs', []))
